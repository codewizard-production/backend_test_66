...
@Entity(name = "College")
@Table(name = "\"College\"", schema =  "\"test\"")
@Data
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"StudentID\""), schema = "\"test\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"CollegeID\""),
            inverseJoinColumns = @JoinColumn( name="\"CourseID\""), schema = "\"test\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"CollegeID\""),
            inverseJoinColumns = @JoinColumn( name="\"DeptID\""), schema = "\"test\"")
